...
L.AwesomeMarkers.Icon = L.Icon.extend({
  options: {
    ...
    color: 'blue',
    iconColor: 'white',
    linkImg: false,//是否是外部链接图片
    digital: false //是否是数字显示
  },
  ...
  _createInner: function() {
    ...
    if(this.options.linkImg){
      return "<span class='icon-img "+iconClass+"'></span>"
    }

    if(this.options.digital){
      return "<span class='icon-digital "+iconClass+"'>"+(this.options.icon)+"</span>"
    }
