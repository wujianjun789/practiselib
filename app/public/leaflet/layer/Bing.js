...
function createMapLayer(mapObj, key) {
  ...
  var imagerySet = "Road";
  var bing_road = new L.BingLayer(key, {type: imagerySet});
  var bing_aerial = new L.BingLayer(key, {type: "Aerial"});
  var bing_aerial2 = new L.BingLayer(key, {type: "AerialWithLabels"});
