                ...
                <header>
                    <div className="main-title">
                        <svg className="svgOnload"> 
                            <defs>
                                <linearGradient id="linear_login_login" x1="0%" y1="0%" x2="0%" y2="100%">
                            ...
                            <symbol id="login_logo"><path fill="url(#linear_login_login)" d="M100,3C46.428,3,3,46.428,3,100s43.428,97,97,97s97-43.428,97-97S153.572,3,100,3z M96.869,41.074
