                        ...
                        <div className="panel panel-default strategy-info">
                            ...
                            <div className={"panel-body " + (sidebarInfo.parameterCollapsed ? 'collapsed' : '')}>
                                <div className='form-group'>
                                    ...
                                    <div className='input-container'>
                                        <input type='text' className='form-control' value={selectItem.hasOwnProperty('excuteTime')?selectItem.excuteTime :''} disabled="disabled"/>
                                    </div>
                                </div>
                                <div className='form-group'>
                                ...
                                <div className='form-group'>
                                    ...
                                    <div className='input-container'>
                                        <input type='text' className='form-control' value={selectItem.excuteOffset?selectItem.excuteOffset:''} disabled="disabled" />
                                    </div>
                                </div>
