...
const RenderAssetLibTop = props=>{
    const {assetType, assetSort, assetSearch, assetListPro, showModalPro, onChange, searchSubmit, assetList, showModal, hideModal, addUploadFile} = props;
    return <div className="top">
        <Select className="asset-type" data={assetType}
                onChange={selectIndex => onChange("assetType", selectIndex)}></Select>
