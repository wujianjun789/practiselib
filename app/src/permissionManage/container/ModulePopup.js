                        ...
                        <div className='all-module-list'>
                            <ul>
                            {
                                modules.map((item,index)=>{
                                    return <li key = {index}>
                                        {    
                                            IsExitInArray(moduleList,item.key)?<span className='list-node-add'>已添加</span>:<span className='glyphicon glyphicon-plus' onClick={()=>this.moduleAdd(item.key)}></span>
                                        }
                                        {item.title}                                        
                                    </li>
                                })
                            ...
                            <ul>
                                {
                                    moduleList.map((item,index)=>{
                                        return <li key = {index}>
                                            ...
                                            {getObjectByKeyObj(modules,'key',item)['title']}
                                        </li>
                                    })
                                }
                            </ul>
