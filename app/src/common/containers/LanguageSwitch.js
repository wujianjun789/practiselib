...
export default class LanguageSwitch extends Component{
    ...
    render(){
        ...
        return <div className={"language-switch "+className}>
                <svg className="svgOnload">
                    <symbol id="zh"><path d="M180.667,95c0,0,0,32.166,0,37.833S177.5,144,169.5,144S32.276,144.167,29,144.167c-3.276,0-10.812-1.583-10.812-10.5
    ...
    c0.369,0.028,1.685,1.008,1.634,1.175l0.098,18.262L180.667,95z"/></symbol>
                                <symbol id="en"><path d="M55.425,101.469v22.758c-0.101,0.834,1.953,2.851,2.595,2.854h25.324c0.187,0.051,0.928-0.309,1.038-0.519
