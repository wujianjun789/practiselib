                ...
                if(item.device_id===id){
                    this.state.resDevice.toJS().map(dItem=>{
                         if(dItem.id===id){
                             ...
                             this.setState({deviceList:aa},()=>{console.log(this.state.deviceList)});
                         }
                    })
                    let pushCurPosition = [];
                    pushCurPosition.push(item);
                    this.setState({curPosition:pushCurPosition},()=>{console.log(this.state.curPosition)});
                }
            })
            //this.setState({searchList:this.state.searchList.push(item)},()=>{console.log(this.state.searchList)});
            this.setSize();
...
"/></symbol>
<symbol id="collect"><path d="M180.327,7.47h-75.671c-6.719,0-12.166,5.492-12.166,12.268v72.38l-19.613,0.007V35.073c0-5.081-4.085-9.201-9.124-9.201
        h-18.25v-6.134c0-6.775-5.447-12.268-12.165-12.268H21.172c-6.719,0-12.166,5.492-12.166,12.268v20.978
        c0,6.775,5.447,12.268,12.166,12.268h12.166c6.719,0,12.166-5.492,12.166-12.268v-5.643h18.249v57.045h-18.25v-7.483
        c0-6.775-5.447-12.268-12.166-12.268H21.172c-6.719,0-12.166,5.492-12.166,12.268v29.688c0,6.775,5.447,12.268,12.166,12.268
        h12.166c6.719,0,12.166-5.492,12.166-12.268v-7.483h18.249v57.045h-18.25v-5.643c0-6.775-5.447-12.268-12.166-12.268H21.172
        c-6.719,0-12.166,5.492-12.166,12.268v20.978c0,6.775,5.447,12.268,12.166,12.268h12.166c6.719,0,12.166-5.492,12.166-12.268
        v-6.134h18.249c5.039,0,9.124-4.119,9.124-9.201v-57.01l19.248-0.036v72.38c0,6.775,5.447,12.268,12.166,12.268h76.036
        c6.719,0,12.166-5.492,12.166-12.268V19.738C192.493,12.963,187.046,7.47,180.327,7.47z M36.379,40.716
        c0.017,1.788-1.285,3.311-3.041,3.558H21.172c-1.949,0-3.528-1.593-3.528-3.558V19.738c0.245-1.771,1.755-3.084,3.528-3.067h12.166
        c1.586,0.209,2.834,1.468,3.041,3.067V40.716z M36.866,114.323c0,1.965-1.58,3.558-3.528,3.558H21.172
        c-1.949,0-3.528-1.593-3.528-3.558V84.635c0-1.965,1.58-3.558,3.528-3.558h12.166c1.948,0,3.528,1.593,3.528,3.558V114.323z
         M36.866,179.22c0,1.965-1.58,3.558-3.528,3.558H21.172c-1.756-0.247-3.058-1.77-3.041-3.558v-20.978
        c-0.017-1.788,1.285-3.311,3.041-3.558h12.166c1.948,0,3.528,1.593,3.528,3.558V179.22z M183.733,179.219
        c0,1.897-1.525,3.435-3.406,3.435h-75.671v-0.368c-1.748,0.01-3.219-1.315-3.406-3.067V19.738c0.187-1.752,1.659-3.077,3.406-3.067
        h75.671c1.881,0,3.406,1.538,3.406,3.435V179.219z
"/></symbol>
