    ...
    render(){
        ...
        return <div className="sidebar">
                <div className="edit-container">
                    <div className="glyphicon glyphicon-plus" onClick={()=>this.onClick('add')}></div>
                    <div className="glyphicon glyphicon-remove pull-right" onClick={()=>this.onClick('remove')}></div>
                    <div className="glyphicon glyphicon-arrow-down pull-right" onClick={()=>this.onClick('down')}></div>
                    <div className="glyphicon glyphicon-arrow-up pull-right" onClick={()=>this.onClick('up')}></div>
